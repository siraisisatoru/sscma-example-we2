#"tensorflow (Master/26.05) - 730449fef1510c5d7848a4e9f0069ba357c16b96":
#"https://github.com/tensorflow/tflite-micro/archive/730449fef1510c5d7848a4e9f0069ba357c16b96.zip"

#u55 driver (26.05 - May 2026 release, includes YOLO26 support)
#"core-driver": "https://git.mlplatform.org/ml/ethos-u/ethos-u-core-driver.git/snapshot/ethos-u-core-driver-26.05.tar.gz"

# directory declaration
LIB_INFERENCE_ENGINE_DIR = $(LIBRARIES_ROOT)/inference/tflmtag2605_u55tag2605
LIB_INFERENCE_ENGINE_DEFINES = -DTFLM2605_U55TAG2605
...
# When CMSIS-NN is enabled, include ONLY CMSIS-NN optimized kernels
# Do NOT include default pad.cc or transpose.cc - use CMSIS-NN versions only
LIB_INFERENCE_ENGINE_CXXSRCS += \
$(LIB_INFERENCE_ENGINE_DIR)/tensorflow/lite/micro/kernels/add_common.cc \
$(LIB_INFERENCE_ENGINE_DIR)/tensorflow/lite/micro/kernels/conv_common.cc \
$(LIB_INFERENCE_ENGINE_DIR)/tensorflow/lite/micro/kernels/depthwise_conv_common.cc \
...
$(LIB_INFERENCE_ENGINE_DIR)/tensorflow/lite/micro/kernels/cmsis_nn/maximum_minimum.cc \
$(LIB_INFERENCE_ENGINE_DIR)/tensorflow/lite/micro/kernels/cmsis_nn/mul.cc \
$(LIB_INFERENCE_ENGINE_DIR)/tensorflow/lite/micro/kernels/cmsis_nn/pad.cc \
...
$(LIB_INFERENCE_ENGINE_DIR)/tensorflow/lite/micro/kernels/cmsis_nn/transpose.cc \
...
# genearte library
ifeq ($(LIB_CMSIS_NN_ENALBE), 1)
INFERENCE_ENGINE_LIB_NAME = libtflmtag2605_u55tag2605_cmsisnn_$(TOOLCHAIN).a
lib_sel += cmsis_nn
else
INFERENCE_ENGINE_LIB_NAME = libtflmtag2605_u55tag2605_$(TOOLCHAIN).a
endif
